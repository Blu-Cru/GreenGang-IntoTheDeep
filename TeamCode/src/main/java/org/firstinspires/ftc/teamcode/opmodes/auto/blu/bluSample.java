...
import org.firstinspires.ftc.teamcode.common.commands.controls.clawArm.ClawArmParkCommand;
...
import org.firstinspires.ftc.teamcode.common.commands.spec.auto.SampleAutoResetCommand;
...
//                SAMPLE 1
                ...
                // PARK
                .setTangent(-90)
                .splineToLinearHeading(new Pose2d(19, 8, Math.toRadians(0)), Math.toRadians(180))
                .build();
